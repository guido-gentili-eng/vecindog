    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 p-0 backdrop-blur-sm sm:items-center sm:p-4">
      <div className="w-full max-w-sm rounded-t-[32px] bg-white px-7 pb-10 pt-7 shadow-2xl sm:rounded-[32px] sm:pb-8 max-h-[92dvh] overflow-y-auto">
        ...
        <div className="mb-6 text-center">
          <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-white shadow-soft overflow-hidden">
            {step === 'confirm'
              ? <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-primary"><KeyRound className="h-8 w-8 text-white" /></span>
              : <VecindogIcon className="h-12 w-auto" />}
          </span>
...
function VecindogIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 59.57 89.72" xmlns="http://www.w3.org/2000/svg" className={className} aria-hidden="true">
