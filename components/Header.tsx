...
import { Plus, Menu, X, LogOut, User, Megaphone, MapPin, Dog, Map, BookOpen } from 'lucide-react';
...
export default function Header() {
  ...
  const { user, isGuest, isAuthenticated, signOut, loading, ciudad, clearCiudad } = useAuth();
    ...
    <header className="sticky top-0 z-30 border-b border-black/5 bg-white/85 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Estado de autenticación (desktop) */}
          {!loading && (
