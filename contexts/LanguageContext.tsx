...
const translations: Record<Lang, Translations> = {
  ...
  es: {
    ...
    plansTrialBadge: '🎁 Primeros 3 meses GRATIS',
    plansTrialAfter: 'Después',
    plansActivating: 'Activando…',
    plansStartFree: '🎁 Empezar gratis — primeros 3 meses sin costo',
    plansPayNow: 'O pagar ahora',
    plansTrialActive: '¡Tus primeros 3 meses gratis están activos! 🎉',
    ...
    rvnPromoMonths: 'los primeros 3 meses',
    rvnPromoLuego: 'Luego',
    ...
    rvnErrPhoneDigits: 'El teléfono debe tener al menos 10 dígitos. Ejemplo: +54 9 291 5782910',
    ...
    pbrContactoError: 'Número incompleto — ingresá el número completo con código de área. Ej: +54 9 291 5782910',
    ...
    pbrWhatsappError: 'El WhatsApp debe tener al menos 10 dígitos. Ejemplo: +54 9 291 5782910',
    ...
    rvpxPlan: 'Red Vecindog · 90 días gratis',
    ...
    cubcContactoError: 'Número incompleto — ingresá el número completo con código de área. Ej: +54 9 291 5782910',
    ...
    cubcErrContactoShort: 'El WhatsApp debe tener al menos 10 dígitos. Ejemplo: +54 9 291 5782910',
    ...
    qqcErrContactoShort: 'El WhatsApp debe tener al menos 10 dígitos. Ejemplo: +54 9 291 5782910',
    ...
    publModalErrLogoReq: 'Subí el logo de tu negocio para este plan.',
    ...
    publModalErrTel: 'El teléfono debe tener al menos 10 dígitos. Ejemplo: +54 9 291 5782910',
  ...
  en: {
    ...
    plansTrialBadge: '🎁 First 3 months FREE',
    plansTrialAfter: 'Then',
    plansActivating: 'Activating…',
    plansStartFree: '🎁 Start free — first 3 months at no cost',
    plansPayNow: 'Or pay now',
    plansTrialActive: 'Your first 3 months free are active! 🎉',
    ...
    rvnPromoMonths: 'for the first 3 months',
    rvnPromoLuego: 'Then',
    ...
    rvnErrPhoneDigits: 'Phone must have at least 10 digits. Example: +54 9 291 5782910',
    ...
    pbrContactoError: 'Incomplete number — enter the full number with area code. E.g.: +54 9 291 5782910',
    ...
    pbrWhatsappError: 'WhatsApp must have at least 10 digits. Example: +54 9 291 5782910',
    ...
    rvpxPlan: 'Vecindog Network · 90 days free',
    ...
    cubcContactoError: 'Incomplete number — enter the full number with area code. e.g. +54 9 291 5782910',
    ...
    cubcErrContactoShort: 'WhatsApp must have at least 10 digits. Example: +54 9 291 5782910',
    ...
    qqcErrContactoShort: 'WhatsApp must have at least 10 digits. Example: +54 9 291 5782910',
    ...
    publModalErrLogoReq: 'Upload your business logo for this plan.',
  ...
  pt: {
    ...
    plansTrialBadge: '🎁 Primeiros 3 meses GRÁTIS',
    plansTrialAfter: 'Depois',
    plansActivating: 'Ativando…',
    plansStartFree: '🎁 Começar grátis — primeiros 3 meses sem custo',
    plansPayNow: 'Ou pagar agora',
    plansTrialActive: 'Seus primeiros 3 meses grátis estão ativos! 🎉',
    ...
    rvnPromoMonths: 'os primeiros 3 meses',
    ...
    rvnErrPhoneDigits: 'O telefone deve ter pelo menos 10 dígitos. Exemplo: +54 9 291 5782910',
    ...
    pbrContactoError: 'Número incompleto — insira o número completo com código de área. Ex.: +54 9 291 5782910',
    ...
    pbrFotoPesada: 'pesa {mb} MB.',
    pbrWhatsappError: 'O WhatsApp deve ter pelo menos 10 dígitos. Exemplo: +54 9 291 5782910',
    ...
    rvpxPlan: 'Rede Vecindog · 90 dias grátis',
    ...
    cubcContactoError: 'Número incompleto — insira o número completo com DDD. Ex.: +54 9 291 5782910',
    cubcPublicar: 'Publicar aviso',
    ...
    cubcErrContactoShort: 'O WhatsApp deve ter pelo menos 10 dígitos. Exemplo: +54 9 291 5782910',
    ...
    qqcErrContactoShort: 'O WhatsApp deve ter pelo menos 10 dígitos. Exemplo: +54 9 291 5782910',
    ...
    publModalErrLogoReq: 'Envie a logo do seu negócio para este plano.',
