...
const POSTS_FIELDS = 'id,created_at,user_id,perro_id,categoria,especie,nombre,raza,color,tamano,collar,chapita,descripcion,zona,fecha,horario,contacto,images,estado,lat,lng,sexo,situacion_transito,fecha_limite_transito';
